...
if __name__ == '__main__':
    ...
    setup(
        ...
        ext_modules=[
            ...
            # PointPillar demo/inference does not use pointnet2 ops. The original
            # 2021 pointnet2 sources include THC/THC.h, which is removed in the
            # current PyTorch 2.x environment, so skip them for this reproduction.
        ],
    )
