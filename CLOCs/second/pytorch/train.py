...
def train(config_path,
    ...
    target_assigner = target_assigner_builder.build(target_assigner_cfg,
                                                    bv_range, box_coder)
    class_names = target_assigner.classes
    second_config = os.environ.get("CLOCS_SECOND_CONFIG", "./configs/car.fhd.config")
    second_model_dir = os.environ.get("CLOCS_SECOND_MODEL_DIR", "../model_dir")
    net = build_inference_net(second_config, second_model_dir)
